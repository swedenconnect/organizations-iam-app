...
# keycloak/scripts/set-iam-admin-managed.sh, the single implementation of this script, with the
...
# container.
#
# Against any other Keycloak, call keycloak/scripts/set-iam-admin-managed.sh directly.
...
TARGET="${REPO_ROOT}/keycloak/scripts/set-iam-admin-managed.sh"

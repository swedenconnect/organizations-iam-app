...
const translations = {
  en: {
    ...
    'importExport.title': 'Import and Export',
    'importExport.description': 'Import or export organizations, functions and users from/to a JSON file.',
    'importExport.exportTitle': 'Export',
    'importExport.exportDescription': 'Download every organization, function, and user (with their rights) as a JSON file.',
    'importExport.exportButton': 'Export to file',
    'importExport.importTitle': 'Import',
    'importExport.importDescription': 'Upload a JSON file. Existing organizations, functions and users (matched on user\'s primary ID) are detected as duplicates and skipped. Nothing is created until you confirm.',
  ...
  sv: {
    ...
    // Import/Export
    'importExport.tabTitle': 'Import/Export',
    'importExport.title': 'Import och Export',
    'importExport.description': 'Importera eller exportera organisationer, funktioner och användare från/till en JSON-fil.',
    'importExport.exportTitle': 'Export',
    'importExport.exportDescription': 'Ladda ner alla organisationer, funktioner, och användare (med rättigheter) som en JSON-fil.',
    'importExport.exportButton': 'Exportera till fil',
    'importExport.importTitle': 'Import',
    'importExport.importDescription': 'Ladda upp en JSON-fil. Befintliga organisationer, funktioner och användare (matchade på användares primära ID) identifieras som dubbletter och hoppas över. Iinget skapas förrän du bekräftar.',
